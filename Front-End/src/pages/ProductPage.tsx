      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">
            Categoria: <span className="text-gray-800 dark:text-gray-200">{product.category}</span>
          </p>

          <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-6">
            {product.description || "Produto de alta qualidade feito com materiais selecionados."}
          </p>
          ...
          <div className="flex gap-3">
            <button className="bg-primary text-white dark:bg-secondary-dark dark:text-zinc-900 px-6 py-3 rounded-xl hover:scale-105 transition-all font-medium shadow-md">
