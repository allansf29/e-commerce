    ...
    <header className="bg-background dark:bg-background-dark shadow-sm sticky top-0 z-50 transition-colors duration-300">
      ...
      <nav className="container mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link
            to="/"
            className="text-[16px] font-medium text-text dark:text-white hover:text-gray-400 hover:dark:text-secondary transition-colors "
          >
            Home
          </Link>
          <Link
        ...
        {/* Barra de busca */}
        <div className="hidden lg:flex items-center bg-indigo-50 dark:bg-secondary-dark rounded-full px-4 py-2 w-[30%] shadow-inner">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/favorites"
            className="text-muted-foreground hover:text-gray-400 dark:text-muted-foreground dark:hover:text-secondary-dark transition dark:text-text-dark"
          >
          ...
          <Link
            to="/cart"
            className="text-muted-foreground hover:text-gray-400 dark:text-muted-foreground dark:hover:text-secondary-dark transition relative dark:text-text-dark"
          >
